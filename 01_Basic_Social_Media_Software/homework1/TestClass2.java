...
public class TestClass2 {
    ...
    public static void main(String[] args) {
        ...
        accounts[0].addPost(Post1);
        accounts[0].addPost(Post2);
        ...
        accounts[1].viewProfile(accounts[0]);

        System.out.println("liking Post1...");
        accounts[1].addLike(Post1);
        ...
        accounts[2].viewProfile(accounts[0]);

        System.out.println("Commenting on Post2..");
        accounts[2].addComment(Post2, "Nice");

        System.out.println("Sending a message to 'gizemsungu' .");
        accounts[2].message("Hello", accounts[0]);
        ...
        accounts[0].viewProfile(accounts[0]);
