...
public class TestClass4 {
    ...
    public static void main(String[] args) {
        ...
        accounts.get(7).addLike(post3, accounts);

        System.out.println("Liking another post of aaltan..");
        accounts.get(7).addLike(post2, accounts);

        System.out.println("Adding a comment on a post of aaltan...");
        accounts.get(7).addComment(post3,"I love it!", accounts);

        System.out.println("Adding another comment on a post of aaltan...");
        accounts.get(7).addComment(post2,"Whaatt?!", accounts);
        ...
        accounts.get(9).viewProfile(accounts.get(9));

        System.out.println("Unfollowing an account...");

        accounts.get(9).unfollow(accounts.get(0));

        accounts.get(9).viewProfile(accounts.get(9));

        System.out.println("Unfollowing another account...");

        accounts.get(9).unfollow(accounts.get(1));
        ...
        accounts.get(9).addLike(post4, accounts);
