...
public class Account {
    ...
    private LinkedList<Message> messagesOut;
    ...
    public Account(int accId, String uName, String bDate, String loc){
        ...
        birthdate = bDate;
        location = loc;
        following = new LinkedList<String>(); // allocating memory for string.
        followers = new LinkedList<String>();
        messagesIn = new LinkedList<Message>();
        messagesOut = new LinkedList<Message>();  
        blockedAccounts = new LinkedList<Account>();
        posts = new LinkedList<Post>();
        UserActions = new LinkedList<String>();
        accountId = accId;
    }
    ...
    public void login(LinkedList <Account> acc){ // Revise it later.
        for(Account a : acc){
            if(a.isLoggedIn()){
    ...
    public void viewPostInteractions(Account profile, LinkedList <Account> arr){
        if(!isLoggedIn()){
     ...
     * @param acc Account array containing all the users that have been created.
     */
    public void viewInbox(LinkedList <Account> acc){
